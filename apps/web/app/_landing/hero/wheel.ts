 ...
 *
 * **「평균보다 살짝 더」가 기준이다**(2026-09-10 운영자). 브라우저 기본은 한
 * 칸에 100px 안팎인데, 이 화면은 섹션이 커서 그만큼으로는 「거의 안 움직인다」로
 * 느껴진다. 그렇다고 한 칸에 화면 반쯤을 넘기면 읽던 자리를 잃는다.
 *
 * 0.15 면 1000px 화면에서 150px 다 — 기본의 한 배 반. 여섯 칸 반에 한 화면이
 * 지나간다. 한때 0.4(두 칸 반에 한 화면)로 뒀는데 그건 「살짝」이 아니었다.
 *
 ...
 */
export const WHEEL_SCREEN_RATIO = 0.15;
