...
export const KO = {
  ...
  loop: [
    ...
    { n: "02", name: "라이브러리", desc: "수집한 글, 사용자가 올린 참고 이미지, 묶음 세트, 만든 작업물이 한자리에. 로그인하면 여기가 먼저 열립니다." },
  ...
  diffRows: [
    ...
    { item: "소재 확보", a: "직접 찾아 옵니다", b: "직접 찾아 옵니다", c: "유튜브 · RSS · 뉴스 · 커뮤니티에서 워커가 자동으로 모읍니다" },
...
export const EN: LandingCopy = {
  ...
  diffRows: [
    ...
    { item: "Sourcing material", a: "You go find it", b: "You go find it", c: "A worker collects from YouTube, RSS, news and communities" },
